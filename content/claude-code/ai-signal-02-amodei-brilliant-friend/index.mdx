---
title: "Anthropic's \"brilliant friend\" spec — and how we use it to audit AI advisor products"
slug: ai-signal-02-amodei-brilliant-friend
tool: claude-code
...
source_links:
  - label: "Anthropic's Claude model spec"
    url: https://www.anthropic.com/constitution
---

# Signal from the Timeline #2: Anthropic's "brilliant friend" specification

*A recurring series: we pull a post or document from an AI leader, add live commentary from our production work, and ship it as a Cables entry.*
...
>
> — [**Anthropic model spec (Claude's constitution)**](https://www.anthropic.com/constitution), published publicly by Anthropic

Dario Amodei (CEO, Anthropic) has consistently reinforced this framing in public appearances and in his October 2024 essay *Machines of Loving Grace*. The model spec is where it became a design constraint, not just a philosophy.
...
**Signal #3** — Boris Cherny (creator of Claude Code) reveals his actual workflow: 5-10 parallel Claude instances, Opus with thinking for everything, and a slash command he runs dozens of times per day.
